...
if uploaded_file is not None:
    ...
    if menu == "1. 데이터 탐색 및 표준화":
        ...
        * **음수(-):** 해당 변수가 다른 변수들과 복합적으로 작용할 때 나타나는 상대적 하락 요인 또는 통계적 노이즈를 의미합니다.
        ...
        # 여기가 에러가 났던 부분입니다. 한 줄로 묶었습니다.
        st.warning("전체적인 설명력이 높지 않다는 점은, 현재의 정량적 평가 시스템이 실제 사회의 복합적인 보상 체계를 완벽히 대변하지 못함을 뜻합니다.")
        
        st.divider()
        st.success("**🚀 최종 시사점**\n\n진로 교육은 점수 경쟁을 넘어, 데이터로 측정되지 않는 **'비인지적 역량(실전 문제해결, 소통, 협업)'**을 강화하는 방향으로 나아가야 합니다.")
